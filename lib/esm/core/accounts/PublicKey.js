...
exports.PublicKey = exports.BECH32_PUBKEY_ACC_PREFIX = void 0;
...
function decompressPubKey(startsWith02Or03) {
    ...
    const compressed = secp256k1_1.default.publicKeyConvert(unit8, false);
...
class PublicKey {
    ...
    toBech32() {
        return bech32_2_1.bech32.encode(exports.BECH32_PUBKEY_ACC_PREFIX, this.key);
    }
    toAddress() {
