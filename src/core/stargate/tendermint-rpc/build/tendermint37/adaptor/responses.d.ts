...
export declare function decodeValidatorUpdate(
...
export declare function decodeValidatorGenesis(
...
export declare class Responses {
  ...
  static decodeNewBlockHeaderEvent(
  ...
  static decodeTxSearch(
    response: JsonRpcSuccessResponse,
  ): responses.TxSearchResponse;

  static decodeValidators(
    response: JsonRpcSuccessResponse,
